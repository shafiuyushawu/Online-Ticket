...
container.className = 'container m-auto flex justify-between items-center text-black md:justify-start';

const hamburger = document.createElement('div');
hamburger.id = 'hamburger';
hamburger.className = 'hamburger block md:hidden py-3 px-4 mx-2 rounded focus:outline-none hover:bg-gra-200 justify-start';
...
ulnav.id = 'navMenu';
ulnav.className = ' md:flex items-center  text-base font-semibold cursor-pointer md:block ';
